...
class PocketBaseClient {
  ...
  async listCollections() {
    const response = await this.adminRequest("GET", "/api/collections", {
  ...
  async getCollection(collectionName) {
    return this.adminRequest("GET", `/api/collections/${encodeURIComponent(collectionName)}`);
  }

  async createCollection(payload) {
    return this.adminRequest("POST", "/api/collections", { payload });
  }

  async updateCollection(collectionNameOrId, payload) {
    return this.adminRequest("PATCH", `/api/collections/${encodeURIComponent(collectionNameOrId)}`, {
      payload
    });
  }
